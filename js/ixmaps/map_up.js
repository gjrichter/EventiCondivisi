...
function _mapup_createMarkerClickHandler(map, marker, layer, info, szMode, i) {
	...
	return function() {
		...
		// make info content
		//
		var szInfo = "<div class=\"InfoWindow\" style=\"max-width:"+(pageWidth*0.80)+"px;max-height:"+(pageHeight*0.66)+"px;overflow:auto\">";

		szInfo += "<div class=\"InfoWindowHeader\" style=\"max-width:"+(pageWidth-80)+"px\">"+szTitle+"<\/div>";
		var szDesc = "";
